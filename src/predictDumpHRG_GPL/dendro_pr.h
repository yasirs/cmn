 ...
 */
	...
	if (flag_debug) { cout << ">> dendro: build dendrogram complete: logL = " << L << endl; }
...
double dendro::getLikelihood() { if (L > 0.0) { return 0.0; } else { return L; } }
...
bool dendro::importDendrogramStructure(const string in_file) {
	...
	cout << ">> dendro: importing hrg file: " << in_file << endl;
